...
function Filter() {
  ...
  const handleApplyFilter = () => {
    // Navigate back to the flight page
    router.push('/flight');
  };
  ...
  return (
    <div className={styles.general}>
      <div className={styles.flg}>
        ...
        >
          <span onClick={handleClear} style={{ textDecoration: "none", color: "#06BCE1" }}>
            Clear <span>x</span>
          </span>
        </p>
      </div>
      <div className={styles.flg} style={{ paddingTop: "20px", paddingBottom: "20px" }}>
      ...
      <div className={styles.rec}>
        <p
          style={{
            backgroundColor: filterState.sortOption === "recommended" ? "#06BCE1" : "transparent",
            color: filterState.sortOption === "recommended" ? "#fff" : "inherit",
            cursor: "pointer",
          }}
        ...
        <p
          style={{
            backgroundColor: filterState.sortOption === "cheapest" ? "#06BCE1" : "transparent",
      ...
      <div className={styles.rec}>
        <p
          style={{
            backgroundColor: filterState.sortOption === "fastest" ? "#06BCE1" : "transparent",

...
function ProfileDetails() {
  return (
    ...
    <div className={styles.bottom}> <Link href="/profilepage" style={{color:"black", textDecoration:"none"}}><span className={styles.cancel}>Cancel</span>  </Link>  <Link  href="/profilepage" style={{color:"black", textDecoration:"none"}} ><span className={styles.changes}>Save Changes</span></Link></div>  </div>
  )
}

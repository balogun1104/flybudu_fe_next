...
=======
      <div className={styles.navbar}> <Link href="/profile-page"> <Image src={Backbutton} alt='' /> </Link><span>Edit Profile</span></div>
      <div className={styles.mother}>
        <div className={styles.firstLine}>
...
=======
      <div className={styles.bottom}> <Link href="/profile-page" style={{color:"black", textDecoration:"none"}}><span className={styles.cancel}>Cancel</span>  </Link>  <Link  href="/profile-page" style={{color:"black", textDecoration:"none"}} ><span className={styles.changes}>Save Changes</span></Link></div>
    </div>
>>>>>>> 399b9c1d7cb072ef7ea17c0aab64fa83017bfccd
  )
}

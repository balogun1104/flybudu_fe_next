...
import {DatePick} from "@nextui-org/date-picker";
        ...
        <div className={styles.heroWrap}>
          ...
          <div className={styles.heroSecondText}>
                ...
                >
                  ...
                  >
                    <div className={styles.whereDropdown}>
                      <label htmlFor="to" style={{ marginLeft: "15px", display:"none" }}>
                        To Where
                      </label>
                      <input
                  ...
                  <div>
                    ...
                    {/* <div className={styles.datePickerContainer}>
                      ...
                      /> 
                       ...
                       <DatePick label="Birth date" className="max-w-[284px]" />
    </div>
                    </div> */}
                     <RangePicker
                          style={{ cursor: "pointer" }}
            ...
            <div className={styles.Letgo}>
              <span>
                {" "}
                <input type="checkbox" name="dates" style={{background:"#fff"}} />

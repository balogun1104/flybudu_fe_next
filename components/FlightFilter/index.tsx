  ...
  return (
    <div className={styles.general}>
            <div className={styles.flg}>
              <Link href="/flight"> <Image src={BackButton} alt=''/></Link>
              <p className={styles.bold} style={{ display: "flex", alignItems: "center", gap: "10px", fontWeight:"bold" }}>
              ...
              >
               <Link href="/flight" style={{textDecoration:"none", color:"#06BCE1"}}> Clear <span onClick={onClick}>x</span></Link>
              </p>
            </div>
            <div
            ...
            <div className={styles.rec}>
              <p style={{ backgroundColor: "#06BCE1", color: "#fff" }}>
                Reconmmeded
              </p>
              <p>Cheapest</p>
            </div>
            ...
            <div className={styles.airline}>
              ...
              <div className={styles.airPeace}>
                ...
                <span>From <span style={{color:"#7A7A7A"}}>#160,000</span></span>
              </div>
              <div className={styles.airPeace}>
                <span>
                  <input type="checkbox" name="" id="" />
            ...
            <div className={styles.filterDiv}>
              <Link href="/flight" style={{textDecoration:"none", color:"black"}}><span className={styles.cancel}>Cancel</span></Link>
              <Link href="/selectflight" style={{textDecoration:"none", color:"black"}}><span className={styles.filter}> Apply Filter</span></Link>
            </div>
          </div>
  )
}

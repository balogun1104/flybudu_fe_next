  ...
  return (
    <div className={styles.general}>
      <div className={styles.detailsDiv}>
        <span className={styles.details}>Enter your Details</span> <div className={styles.lock}>
        <span className={styles.personal}>Your Personal data is protected </span>
   ...
   <label>Surname <span style={{color:"rgba(239, 12, 12, 1)"}}>*</span></label> 
          ...
          <div className={styles.surnameDiv}>
            ...
            <input className={styles.input1} type="text" placeholder="Enter surname here"/>
...
<span className={styles.confirm}>Passenger 1 contact confirmation?</span>
<div className={styles.firstDivk}>
<div className={styles.firstDiv}>
<label className={styles.bold}>Email <span style={{color:"rgba(239, 12, 12, 1)"}} >*</span></label>
    <input className={styles.input} placeholder="Enter Email Address" type="text"/>

</div>
    <div className={styles.titleDiv}>
    
        <label className={`${styles.bold} ${styles.bigger}`}> Phone Number <span style={{color:"rgba(239, 12, 12, 1)"}}>*</span></label>
...
<div className={styles.checkbox}> <input type="checkbox"/> <p>Save this passenger to my FlyBudu Account</p></div>
<div className={styles.checkbox}> <input type="checkbox"/> <p>Get Booking and Payment confirmation</p></div>
